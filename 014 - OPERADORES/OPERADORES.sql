...
Criação de tabela para testar operadores.
...
SELECT * FROM produtos WHERE criado > '2049-06' AND criado < '2049-08';

SELECT * FROM produtos WHERE nome = 'RING Light LED' COLLATE NOCASE;
